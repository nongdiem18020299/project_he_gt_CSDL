...
//    }
    ...
    public function getAlltin($mathanhvien){
        $sql = "SELECT MAQT, MATIN, TIEUDE, "
                ...
                . " FROM tindang WHERE MATHANHVIEN='$mathanhvien' ORDER BY NGAYDANG DESC";
                // "select MATIN, TIEUDE, NOIDUNG, DIADIEMDAU, DIADIEMCUOI, NGAYDANG, GIA, KHOILUONGHANG, TINHTRANG FROM TINDANG WHERE MAQT IS NOT NULL";
        $this->query($sql);
        return $this->fetch();
    }
