        ...
        <div class="box">
            ...
            <div class="product">
                <div class="title" id="tabs">
                    <a class="set number" title="tab1" style="display:block;width:170px;">
                        <p> Thành viên loại 0</p>
                    </a>
                    <a class=" number" title="tab2" style="	display:block;width:170px;">
                        <p>Thành viên loại 1</p>
                    </a>
                    <a class=" number" title="tab3" style="	display:block;width:170px;">
                        <p>Thành viên loại 2</p>
                    </a>
                </div>
                <!--End .title-->
                <div id="tab1">
                    <!-- Table -->
                    <div class="table">
                        <table max-width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                <th width="13">&nbsp;</th>
                                <th>Hình Avatar</th>
                                <th>Mã Thành Viên</th>
                            ...
                            <tr title="Click edit để duyệt và sửa thành viên">
                                ...
                                <td><img width="80px" height="80px"
                                        src="<?php echo $this->AllThanhVien[$i]['HINHDAIDIEN'] ?>" /></td>
                                ...
                                <td><img width="80px" height="80px"
                                        src="<?PHP echo $this->AllThanhVien[$i]['HINHCMNDT']?>" /></td>
                                <td><img width="80px" height="80px"
                                        src="<?PHP echo $this->AllThanhVien[$i]['HINHCMNDS']?>" /></td>
                                <td><?php echo $this->AllThanhVien[$i]['NGAYDANGKY'] ?></td>
                                <td><a href="adminThanhVien/delThanhVien?id=<?php echo $this->AllThanhVien[$i]['MATHANHVIEN'] ?>"
                                        class="ico del"
                                        onclick="return confirm('Ban co chac chan xóa khong?');">Delete</a><a href="#"
                        ...
                        <div class="pagging">
                            ...
                            <div class="right"> <a href="#">Previous</a> <a href="#">1</a> <a href="#">2</a>
