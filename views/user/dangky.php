                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 no-padding">
                           ...
                           <div class="col-md-12 col-sm-12 no-padding form-group col-xs-12">
                             ...
                             <div class="col-md-12 col-sm-12 no-padding form-group col-xs-12">
                                 ...
                                 <input type="text" name="phonenum" id="phonenum" value="" class="form-control" required="Không được rỗng">
                              <span class="help-block"></span>
                           </div>
                            <div class="col-md-12 col-sm-12 no-padding form-group col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12 no-padding form-group col-xs-12">
                              ...
                              <input type="password" name="password" id="password" value="" required class="form-control" placeholder='abc123456789'>
                              <span class="help-block"></span>
                           </div>
                           <div class="col-md-12 col-sm-12 no-padding form-group col-xs-12">
                               <span style="color: red; font-size: 15px">Nhập lại mật khẩu:</span>
                              <input type="password" name="repassword" id="confirm-password" required value="" class="form-control" placeholder='abc123456789'>
                           </div>
